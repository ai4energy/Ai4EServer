...
# !!! Main.UserApp is configured as an alias for Main.Ai4EServer and you might encounter it in some tests
using Main.Ai4EServer, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Ai4EServer tests" begin
  @includetests ARGS
end
